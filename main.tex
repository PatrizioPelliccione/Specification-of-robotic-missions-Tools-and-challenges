...
Our long-term goal is to build better languages, easing the specification of missions, ideally on a higher abstraction level. To this end, we need to improve our empirical understanding of the current state-of-the art of such languages and their environments. In this paper, we contribute in this direction. We present a survey of 29 mission specification environments for mobile robots that come with a visual, end-user-oriented language.
